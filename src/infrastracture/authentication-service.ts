...
class AuthenticationService {
  ...
  async login(email: string, password: string): Promise<[Session, UserAccount]> {
    return this.userAccountRepository.findById(UserAccountId.of(email)).then((userAccount) => {
